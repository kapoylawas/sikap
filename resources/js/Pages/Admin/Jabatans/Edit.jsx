...
export default function JabatansEdit() {
    const { errors, jobs, jabatans } = usePage().props;

    //state
    const [jobsID, setJobsID] = useState(jabatans.job_id);
    const [name, setName] = useState(jabatans.name);
    const [tarifgaji, setTarifgaji] = useState(jabatans.tarifgaji);
