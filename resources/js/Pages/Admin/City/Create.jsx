                    ...
                    <div className="col-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header">
                                <span className="font-weight-bold"><i className="fa fa-home"></i> Add New City</span>
                            </div>
                            <div className="card-body">
                                <form onSubmit={storeCity}>
                                    <div className="mb-3">
                                        <label className="form-label fw-bold">City Name</label>
                                        <input type="text" className="form-control" value={name} onChange={(e) => setName(e.target.value)} placeholder="Enter City Name" />
                                    </div>
                                    {errors.name && (
