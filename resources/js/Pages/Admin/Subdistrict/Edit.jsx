...
export default function SubdistrictEdit() {
    const { errors, subdistrict, cities } = usePage().props;

    //state
    const [name, setName] = useState(subdistrict.name);
    const [cityID, setCityID] = useState(subdistrict.city_id);
    ...
    const updateKelurahan = async (e) => {
        ...
        //sending data
        Inertia.put(`/admin/subdistricts/${subdistrict.id}`, {
    ...
    return (
        <>
            <Head>
                <title>Edit Kelurahan - SIKAP</title>
            </Head>
            <LayoutAccount>
                <Link
